 ...
 */
public class DefaultSequencedReconfigurationPlan implements SequencedReconfigurationPlan {
     ...
     */
    private ManagedElementList<Action> actions;
     ...
     */
    public DefaultSequencedReconfigurationPlan(Configuration src) {
        this(src, null);
    }
     ...
     */
    public DefaultSequencedReconfigurationPlan(Configuration src, Configuration dst) {
        this.actions = new SimpleManagedElementList<Action>();
        this.source = src;
        destination = dst;
    ...
    @Override
    public SequencedExecutionGraph extractExecutionGraph() {
    	SequencedExecutionGraph g = new SequencedExecutionGraph();
    ...
    @Override
    public ManagedElementList<Action> getActions() {
        return this.actions;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !(o instanceof SequencedReconfigurationPlan)) {
            return false;
        }
        SequencedReconfigurationPlan that = (SequencedReconfigurationPlan) o;
