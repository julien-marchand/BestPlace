...
public class Migration extends MovingVirtualMachineAction {
    ...
    public String toString() {
        return new StringBuilder("migrate(")
                .append(this.getVirtualMachine().name())
                .append(",").append(this.getHost().name())
                .append(",").append(this.getDestination().name())
                .append(")").toString();
    }
    ...
    public boolean insertIntoGraph(SequencedExecutionGraph g) {
        return g.getIncomingsFor(getDestination()).add((Action)this) && g.getOutgoingsFor(getHost()).add((Action)this);
    }
