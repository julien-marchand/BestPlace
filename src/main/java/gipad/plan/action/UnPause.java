...
public class UnPause extends VirtualMachineAction {
     ...
     */
    @Override
    public boolean insertIntoGraph(SequencedExecutionGraph graph) {
        return graph.getIncomingsFor(getHost()).add(this);
    }

    @Override
    public String toString() {
        return new StringBuilder("unpause(").append(getVirtualMachine().name()).append(")").toString();
    }
