...
/**
 * A driver to perform a resume action with an shell command executed on the hosting node through a SSH channel.
 * 
 * <table>
 ...
 *  by the name of the virtual machine, the name of the source node that host the state file of the virtual machine and the name of the destination node</td>
 *  <td>-</td>
 * </tr>
 * </table>
...
public class SSHResume extends SSHDriver {
	 ...
	 */
	public SSHResume(Resume a, PropertiesHelper props) throws PropertiesHelperException {
		super(a, props);
		this.action = a;
